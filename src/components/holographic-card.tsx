    ...
    <section id="business-card" className="w-full py-16 md:py-24 bg-transparent flex items-center justify-center">
      ...
      >
        <div className={`flipper ${isFlipped ? 'is-flipped' : ''}`}>
          ...
          <div className="card-face back rounded-2xl bg-card border border-border flex overflow-hidden">
            <div className="w-1/3 bg-foreground flex items-center justify-center p-6">
              <Logo className="h-32 w-32 text-background" />
            </div>
              ...
              <div className="text-left">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <a href="mailto:sarsonasjosephuskim@gmail.com" className="text-sm text-foreground hover:text-primary transition-colors">
                      sarsonasjosephuskim@gmail.com
                    </a>
                  </div>
                  <div className="flex items-center gap-3">
                    <MapPin className="h-5 w-5 text-muted-foreground" />
                    <span className="text-sm text-foreground">Cebu City, Philippines</span>
                  </div>
                </div>
              </div>
